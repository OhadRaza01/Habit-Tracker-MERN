export default function HabitProgressCard({ habits, todayIndex, onToggle, onSelectHabit }) {
    ...
    return (
        <article className="overflow-hidden rounded-2xl border border-[#ece8e2] bg-white shadow-[0_4px_18px_rgba(42,31,20,0.025)]">
            <div className="flex items-start justify-between px-6 pb-5 pt-6"><div><h2 className="text-lg font-bold">Today&apos;s habits</h2><p className="mt-1 text-sm text-[#928b83]">{completedToday} of {habits.length} completed</p></div><button type="button" aria-label="More habit options" className="text-lg font-bold text-[#918a82]">•••</button></div>
